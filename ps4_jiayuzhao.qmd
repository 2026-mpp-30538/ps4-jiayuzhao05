...
```{python}
#| label: fig-enforcement-timeline
#| fig-cap: "Number of enforcement actions over time"
#| fig-width: 10
#| fig-height: 5
...
#| fig-cap: "Criminal and Civil Actions vs. State Enforcement Agencies"
#| fig-width: 10
#| fig-height: 5
...
```{python}
#| label: fig-topic-analysis
#| fig-cap: "Criminal and Civil Actions by Topic"
#| fig-width: 11
#| fig-height: 6
